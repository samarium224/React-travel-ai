...
# Example hotel coordinates and names
hotel_coordinates = {
    'Rose View Hotel': (24.8918, 91.8663),
    'Nazimgarh Resorts': (24.9826, 91.9894),
    'Grand Sultan Tea Resort & Golf': (24.8821, 91.8484),
    'Nirvana Inn': (24.8961, 91.8715),
    'La Vista Hotel': (24.8897, 91.8661),
    'Platinum Grand Hotel': (24.8888, 91.8733),
    'Hotel Star Pacific': (24.8863, 91.8742),
    'Richmond Hotel & Suites': (24.8885, 91.8741),
    'Noorjahan Grand Hotel': (24.8794, 91.8696),
    'Hilltown Hotel': (24.889, 91.8714),
    'Dusai Resort & Spa': (24.8982, 91.8651),
    'Hotel Holy Gate': (24.8913, 91.8662),
    'Hotel Supreme': (24.8881, 91.8732),
    'Kaikobad Hotel International': (24.8837, 91.871),
    'Britannia Hotel': (24.8895, 91.8664),
    'Sikder Resort & Villas': (24.8805, 91.8665),
    'Grand Palace Hotel & Resorts': (24.8862, 91.8693),
    'Rainforest Resort Sylhet': (24.8798, 91.8704),
    'The Tea Garden Resort': (24.8877, 91.8731),
    'Niribili Resort': (24.8844, 91.8682),
}

def find_nearest_hotels(place_coord, num_hotels=2):
    distances = []
    for hotel_name, hotel_coord in hotel_coordinates.items():
        distance = haversine(place_coord, hotel_coord)
        distances.append((hotel_name, distance))
    distances.sort(key=lambda x: x[1])
    return distances[:num_hotels]
